...
const Edit = ()=>{
    ...
    const updatePost = (e)=>{
        e.preventDefault() ;    //TO AVOID AUTOMATIC FORM REFRESH..//
                    ...
                    <div className="col-6">
                        ...
                        <form onSubmit={updatePost}>
                            <div className="group">
                                ...
                                <input type="Text" name="title" id="title" className="group__control"
                                placeholder="Post title" value={state.title} onChange={(e)=>setState({
