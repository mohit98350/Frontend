...
const Create = (props) => {
    ...
    const createPost = e =>{
        ...
        const formData = new FormData();  //javascript class to handle images//
        ...
        dispatch(createAction(formData));    //we can also use dispatch  to call function..//
    }
    useEffect(()=>{
        if(redirect){
                ...
                <div className="row ">
                    <div className="col-6 p-15">
                        <div className="card">
                            <h3 className="card__h3">Create a new post</h3>
                                <div className="group">
                                    ...
                                    <input type="text" name="title" id="title"
                                     value={state.title} onChange={handleInputs}
                            ...
                            <textarea name="description" id="description" cols="30" placeholder="Meta Description..." 
                             rows="10" defaultValue={state.description} 
                             onChange={handleDescription}
                             className="group__control" 
                             maxLength="150"></textarea>
                             <p className="length">Max-Words:150</p>
                    ...
                    <div className="card">
                        ...
                        <div className="group">
                            {slugButton ?<button className="btn btn-default" onClick={handleURL}>
                                Update Slug</button>:''}
                        </div>
                        <div className="group">
